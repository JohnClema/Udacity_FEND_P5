...
var resizePizzas = function(size) {
  ...
  /**
  * CHANGE: Removed redunant dx function that was being called
  */
...
/*
* CHANGE: changed .querySelectorAll to .getElementsByClassName
* CHANGE: Moved phase variable out of the loop and kept it to five constant
* values in an array
*/
...
document.addEventListener('DOMContentLoaded', function() {
  var s = 256;
  var cols = innerWidth / s;
  var rows = innerHeight / s;
  var totalPizzas = Math.ceil(cols * rows);
